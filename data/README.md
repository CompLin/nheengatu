The contents of the `glossary.txt` file of this folder was first copied and pasted as raw text from the glossary in the pages 103-111 of the following book:
